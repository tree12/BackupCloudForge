namespace EdiFabric.Templates.EdifactD96A
{
    ...
    public class Loop_DLI_DIRDEB
    {
        ...
        [ListCount(5)]
        [Pos(5)]
        public virtual List<Loop_CUX_DIRDEB> CUXLoop { get; set; }
        /// <summary>
        /// Loop for ADJUSTMENT DETAILS
        /// </summary>
        [DataMember]
        [ListCount(10)]
        [Pos(6)]
        public virtual List<Loop_AJT_DIRDEB> AJTLoop { get; set; }
    }
    ...
    public class Loop_DOC_DIRDEB
    {
        ...
        [ListCount(1000)]
        [Pos(8)]
        public virtual List<Loop_DLI_DIRDEB> DLILoop { get; set; }
    }
    ...
    public class Loop_LIN_DIRDEB
    {
        ...
        [DataMember]
        [Pos(6)]
        public virtual Loop_MOA_DIRDEB MOALoop { get; set; }
        /// <summary>
        /// Loop for FINANCIAL INSTITUTION INFORMATION
        /// </summary>
        [DataMember]
        [Required]
        [Pos(7)]
        public virtual Loop_FII_DIRDEB FIILoop { get; set; }
        /// <summary>
        ...
        [ListCount(3)]
        [Pos(8)]
        public virtual List<Loop_NAD_DIRDEB> NADLoop { get; set; }
        /// <summary>
        /// Loop for PARTIES TO INSTRUCTION
        /// </summary>
        [DataMember]
        [Pos(9)]
        public virtual Loop_INP_DIRDEB INPLoop { get; set; }
        /// <summary>
        /// Loop for GENERAL INDICATOR
        /// </summary>
        [DataMember]
        [ListCount(10)]
        [Pos(10)]
        public virtual List<Loop_GIS_DIRDEB> GISLoop { get; set; }
        /// <summary>
        /// Loop for PROCESS IDENTIFICATION
        /// </summary>
        [DataMember]
        [Pos(11)]
        public virtual Loop_PRC_DIRDEB PRCLoop { get; set; }
        /// <summary>
        ...
        [ListCount(9999)]
        [Pos(12)]
        public virtual List<Loop_SEQ_DIRDEB> SEQLoop { get; set; }
    }
    ...
    public class Loop_PRC_DIRDEB_2
    {
        ...
        [ListCount(9999)]
        [Pos(3)]
        public virtual List<Loop_DOC_DIRDEB> DOCLoop { get; set; }
        /// <summary>
        /// Loop for GENERAL INDICATOR
        /// </summary>
        [DataMember]
        [Pos(4)]
        public virtual Loop_GIS_DIRDEB_2 GISLoop { get; set; }
    }
    ...
    public class Loop_SEQ_DIRDEB
    {
        ...
        [ListCount(3)]
        [Pos(7)]
        public virtual List<Loop_FII_DIRDEB> FIILoop { get; set; }
        /// <summary>
        /// Loop for NAME AND ADDRESS
        /// </summary>
        [DataMember]
        ...
        [ListCount(3)]
        [Pos(9)]
        public virtual List<Loop_INP_DIRDEB> INPLoop { get; set; }
        /// <summary>
        /// Loop for GENERAL INDICATOR
        /// </summary>
        [DataMember]
        ...
        [DataMember]
        [Pos(11)]
        public virtual Loop_PRC_DIRDEB_2 PRCLoop { get; set; }
    }
    ...
    [Serializable()]
    [DataContract()]
    [Message("EDIFACT", "DIRDEB")]
    public class TSDIRDEB : EdiMessage
    {
        ...
        [ListCount(2)]
        [Pos(5)]
        public virtual List<Loop_RFF_DIRDEB> RFFLoop { get; set; }
        /// <summary>
        /// Loop for FINANCIAL INSTITUTION INFORMATION
        /// </summary>
        [DataMember]
        ...
        [ListCount(9999)]
        [Pos(8)]
        public virtual List<Loop_LIN_DIRDEB> LINLoop { get; set; }
        /// <summary>
        /// CONTROL TOTAL
        /// </summary>
        [DataMember]
        ...
        [ListCount(5)]
        [Pos(10)]
        public virtual List<Loop_AUT_DIRDEB> AUTLoop { get; set; }
        /// <summary>
        /// Message Trailer
        /// </summary>
        [DataMember]
