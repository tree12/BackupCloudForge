namespace EdiFabric.Templates.EdifactD96A
{
    ...
    public class Loop_EQD_COPINO
    {
        ...
        [ListCount(9)]
        [Pos(8)]
        public virtual List<Loop_TDT_COPINO> TDTLoop { get; set; }
        /// <summary>
        /// NAME AND ADDRESS
        /// </summary>
        [DataMember]
    ...
    public class TSCOPINO : EdiMessage
    {
        ...
        [Required]
        [Pos(5)]
        public virtual Loop_TDT_COPINO TDTLoop { get; set; }
        /// <summary>
        /// Loop for NAME AND ADDRESS
        /// </summary>
        [DataMember]
        ...
        [ListCount(9)]
        [Pos(6)]
        public virtual List<Loop_NAD_COPINO> NADLoop { get; set; }
        /// <summary>
        /// Loop for GOODS ITEM DETAILS
        /// </summary>
        [DataMember]
        [ListCount(999)]
        [Pos(7)]
        public virtual List<Loop_GID_COPINO> GIDLoop { get; set; }
        /// <summary>
        /// Loop for EQUIPMENT DETAILS
        /// </summary>
        [DataMember]
        ...
        [ListCount(999)]
        [Pos(8)]
        public virtual List<Loop_EQD_COPINO> EQDLoop { get; set; }
        /// <summary>
        /// CONTROL TOTAL
        /// </summary>
        [DataMember]
