namespace EdiFabric.Templates.EdifactD96A
{
    ...
    public class Loop_CNI_IFCSUM
    {
        ...
        [ListCount(9)]
        [Pos(2)]
        public virtual List<Loop_SGP_IFCSUM> SGPLoop { get; set; }
        /// <summary>
        ...
        [ListCount(9)]
        [Pos(3)]
        public virtual List<Loop_TPL_IFCSUM> TPLLoop { get; set; }
        /// <summary>
        /// CONTACT INFORMATION
        /// </summary>
        [DataMember]
        ...
        [ListCount(99)]
        [Pos(12)]
        public virtual List<Loop_LOC_IFCSUM> LOCLoop { get; set; }
        /// <summary>
        ...
        [ListCount(2)]
        [Pos(13)]
        public virtual List<Loop_TOD_IFCSUM> TODLoop { get; set; }
        /// <summary>
        /// Loop for REFERENCE
        /// </summary>
        [DataMember]
        [ListCount(99)]
        [Pos(14)]
        public virtual List<Loop_RFF_IFCSUM> RFFLoop { get; set; }
        /// <summary>
        ...
        [ListCount(9)]
        [Pos(15)]
        public virtual List<Loop_GOR_IFCSUM> GORLoop { get; set; }
        /// <summary>
        ...
        [ListCount(9)]
        [Pos(16)]
        public virtual List<Loop_CPI_IFCSUM> CPILoop { get; set; }
        /// <summary>
        ...
        [ListCount(99)]
        [Pos(17)]
        public virtual List<Loop_TCC_IFCSUM_3> TCCLoop { get; set; }
        /// <summary>
        ...
        [ListCount(99)]
        [Pos(18)]
        public virtual List<Loop_TDT_IFCSUM_2> TDTLoop { get; set; }
        /// <summary>
        ...
        [ListCount(99)]
        [Pos(19)]
        public virtual List<Loop_NAD_IFCSUM_2> NADLoop { get; set; }
        /// <summary>
        ...
        [ListCount(999)]
        [Pos(20)]
        public virtual List<Loop_GID_IFCSUM> GIDLoop { get; set; }
        /// <summary>
        ...
        [ListCount(999)]
        [Pos(21)]
        public virtual List<Loop_EQD_IFCSUM_2> EQDLoop { get; set; }
    }
    ...
    public class Loop_DGS_IFCSUM
    {
        ...
        [ListCount(9)]
        [Pos(3)]
        public virtual List<Loop_CTA_IFCSUM> CTALoop { get; set; }
        /// <summary>
        ...
        [ListCount(9)]
        [Pos(4)]
        public virtual List<Loop_MEA_IFCSUM> MEALoop { get; set; }
        /// <summary>
        /// Loop for SPLIT GOODS PLACEMENT
        /// </summary>
        [DataMember]
    ...
    public class Loop_EQD_IFCSUM
    {
        ...
        [ListCount(99)]
        [Pos(13)]
        public virtual List<Loop_EQA_IFCSUM> EQALoop { get; set; }
    }
    ...
    public class Loop_EQD_IFCSUM_2
    {
        ...
        [ListCount(99)]
        [Pos(11)]
        public virtual List<Loop_TCC_IFCSUM_2> TCCLoop { get; set; }
        /// <summary>
        /// Loop for NAME AND ADDRESS
        /// </summary>
        [DataMember]
        [ListCount(9)]
        [Pos(12)]
        public virtual List<Loop_NAD_IFCSUM_3> NADLoop { get; set; }
        /// <summary>
        /// Loop for ATTACHED EQUIPMENT
        /// </summary>
        [DataMember]
    ...
    public class Loop_GID_IFCSUM
    {
        ...
        [ListCount(99)]
        [Pos(13)]
        public virtual List<Loop_DIM_IFCSUM> DIMLoop { get; set; }
        /// <summary>
        /// Loop for REFERENCE
        /// </summary>
        [DataMember]
        ...
        [ListCount(9)]
        [Pos(15)]
        public virtual List<Loop_PCI_IFCSUM> PCILoop { get; set; }
        /// <summary>
        /// Loop for DOCUMENT/MESSAGE DETAILS
        /// </summary>
        [DataMember]
        [ListCount(9)]
        [Pos(16)]
        public virtual List<Loop_DOC_IFCSUM_2> DOCLoop { get; set; }
        /// <summary>
        /// Loop for GOVERNMENTAL REQUIREMENTS
        /// </summary>
        [DataMember]
        ...
        [ListCount(99)]
        [Pos(20)]
        public virtual List<Loop_TCC_IFCSUM> TCCLoop { get; set; }
        /// <summary>
        /// Loop for DANGEROUS GOODS
        /// </summary>
        [DataMember]
        [ListCount(9)]
        [Pos(21)]
        public virtual List<Loop_DGS_IFCSUM> DGSLoop { get; set; }
    }
    ...
    public class Loop_GOR_IFCSUM
    {
        ...
        [ListCount(9)]
        [Pos(6)]
        public virtual List<Loop_DOC_IFCSUM> DOCLoop { get; set; }
    }
    ...
    [DataContract()]
    [Group(typeof(LOC))]
    public class Loop_LOC_IFCSUM_2
    {
    ...
    public class Loop_NAD_IFCSUM_2
    {
        ...
        [ListCount(99)]
        [Pos(9)]
        public virtual List<Loop_TSR_IFCSUM> TSRLoop { get; set; }
    }
    ...
    [DataContract()]
    [Group(typeof(TCC))]
    public class Loop_TCC_IFCSUM_2
    {
    ...
    [DataContract()]
    [Group(typeof(TCC))]
    public class Loop_TCC_IFCSUM_3
    {
    ...
    public class Loop_TDT_IFCSUM
    {
        ...
        [ListCount(9)]
        [Pos(10)]
        public virtual List<Loop_NAD_IFCSUM> NADLoop { get; set; }
    }
    ...
    public class Loop_TDT_IFCSUM_2
    {
        ...
        [ListCount(99)]
        [Pos(4)]
        public virtual List<Loop_LOC_IFCSUM_2> LOCLoop { get; set; }
        /// <summary>
        /// Loop for REFERENCE
        /// </summary>
        [DataMember]
        [ListCount(9)]
        [Pos(5)]
        public virtual List<Loop_RFF_IFCSUM_2> RFFLoop { get; set; }
    }
    ...
    [Serializable()]
    [DataContract()]
    [Message("EDIFACT", "IFCSUM")]
    public class TSIFCSUM : EdiMessage
    {
        ...
        [ListCount(9)]
        [Pos(10)]
        public virtual List<Loop_TDT_IFCSUM> TDTLoop { get; set; }
        /// <summary>
        /// Loop for EQUIPMENT DETAILS
        /// </summary>
        [DataMember]
        [ListCount(999)]
        [Pos(11)]
        public virtual List<Loop_EQD_IFCSUM> EQDLoop { get; set; }
        /// <summary>
        /// Loop for CONSIGNMENT INFORMATION
        /// </summary>
        [DataMember]
        [ListCount(9999)]
        [Pos(12)]
        public virtual List<Loop_CNI_IFCSUM> CNILoop { get; set; }
        /// <summary>
        /// Message Trailer
        /// </summary>
        [DataMember]
