namespace EdiFabric.Templates.EdifactD96A
{
    ...
    public class Loop_CNI_COSTOR
    {
        ...
        [ListCount(999)]
        [Pos(4)]
        public virtual List<Loop_GID_COSTOR> GIDLoop { get; set; }
    }
    ...
    public class Loop_DGS_COSTOR
    {
        ...
        [ListCount(999)]
        [Pos(4)]
        public virtual List<Loop_SGP_COSTOR> SGPLoop { get; set; }
    }
    ...
    public class Loop_EQD_COSTOR
    {
        ...
        [ListCount(9)]
        [Pos(8)]
        public virtual List<Loop_NAD_COSTOR_2> NADLoop { get; set; }
    }
    ...
    public class Loop_GID_COSTOR
    {
        ...
        [ListCount(9)]
        [Pos(12)]
        public virtual List<Loop_DGS_COSTOR> DGSLoop { get; set; }
    }
    ...
    [DataContract()]
    [Group(typeof(NAD))]
    public class Loop_NAD_COSTOR_2
    {
    ...
    [Serializable()]
    [DataContract()]
    [Message("EDIFACT", "COSTOR")]
    public class TSCOSTOR : EdiMessage
    {
        ...
        [Required]
        [Pos(5)]
        public virtual Loop_TDT_COSTOR TDTLoop { get; set; }
        /// <summary>
        /// Loop for NAME AND ADDRESS
        /// </summary>
        [DataMember]
        ...
        [ListCount(9)]
        [Pos(6)]
        public virtual List<Loop_NAD_COSTOR> NADLoop { get; set; }
        /// <summary>
        /// Loop for EQUIPMENT DETAILS
        /// </summary>
        [DataMember]
        ...
        [ListCount(999)]
        [Pos(7)]
        public virtual List<Loop_EQD_COSTOR> EQDLoop { get; set; }
        /// <summary>
        /// Loop for CONSIGNMENT INFORMATION
        /// </summary>
        [DataMember]
        ...
        [ListCount(999)]
        [Pos(8)]
        public virtual List<Loop_CNI_COSTOR> CNILoop { get; set; }
        /// <summary>
        /// CONTROL TOTAL
        /// </summary>
        [DataMember]
