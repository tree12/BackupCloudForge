namespace EdiFabric.Templates.EdifactD96A
{
    ...
    public class Loop_ALC_QUOTES
    {
        ...
        [DataMember]
        [Pos(4)]
        public virtual Loop_QTY_QUOTES_2 QTYLoop { get; set; }
        /// <summary>
        /// Loop for PERCENTAGE DETAILS
        /// </summary>
        [DataMember]
        [Pos(5)]
        public virtual Loop_PCD_QUOTES PCDLoop { get; set; }
        /// <summary>
        ...
        [ListCount(2)]
        [Pos(6)]
        public virtual List<Loop_MOA_QUOTES> MOALoop { get; set; }
        /// <summary>
        /// Loop for RATE DETAILS
        /// </summary>
        [DataMember]
        [Pos(7)]
        public virtual Loop_RTE_QUOTES RTELoop { get; set; }
        /// <summary>
        ...
        [ListCount(5)]
        [Pos(8)]
        public virtual List<Loop_TAX_QUOTES_2> TAXLoop { get; set; }
    }
    ...
    public class Loop_ALC_QUOTES_2
    {
        ...
        [ListCount(10)]
        [Pos(4)]
        public virtual List<Loop_QTY_QUOTES_2> QTYLoop { get; set; }
        /// <summary>
        /// Loop for PERCENTAGE DETAILS
        /// </summary>
        [DataMember]
        [ListCount(10)]
        [Pos(5)]
        public virtual List<Loop_PCD_QUOTES> PCDLoop { get; set; }
        /// <summary>
        /// Loop for MONETARY AMOUNT
        /// </summary>
        [DataMember]
        ...
        [ListCount(10)]
        [Pos(7)]
        public virtual List<Loop_RTE_QUOTES> RTELoop { get; set; }
        /// <summary>
        /// Loop for DUTY/TAX/FEE DETAILS
        /// </summary>
        [DataMember]
    ...
    public class Loop_LIN_QUOTES
    {
        ...
        [ListCount(999)]
        [Pos(16)]
        public virtual List<Loop_CCI_QUOTES> CCILoop { get; set; }
        /// <summary>
        /// Loop for MONETARY AMOUNT
        /// </summary>
        [DataMember]
        [ListCount(100)]
        [Pos(17)]
        public virtual List<Loop_MOA_QUOTES_2> MOALoop { get; set; }
        /// <summary>
        /// Loop for ADJUSTMENT DETAILS
        /// </summary>
        [DataMember]
        [Pos(18)]
        public virtual Loop_AJT_QUOTES AJTLoop { get; set; }
        /// <summary>
        ...
        [ListCount(99)]
        [Pos(19)]
        public virtual List<Loop_PRI_QUOTES> PRILoop { get; set; }
        /// <summary>
        /// Loop for REFERENCE
        /// </summary>
        [DataMember]
        [ListCount(99)]
        [Pos(20)]
        public virtual List<Loop_RFF_QUOTES> RFFLoop { get; set; }
        /// <summary>
        ...
        [ListCount(100)]
        [Pos(21)]
        public virtual List<Loop_LOC_QUOTES_2> LOCLoop { get; set; }
        /// <summary>
        /// Loop for DUTY/TAX/FEE DETAILS
        /// </summary>
        [DataMember]
        [ListCount(10)]
        [Pos(22)]
        public virtual List<Loop_TAX_QUOTES> TAXLoop { get; set; }
        /// <summary>
        ...
        [ListCount(5)]
        [Pos(23)]
        public virtual List<Loop_TOD_QUOTES> TODLoop { get; set; }
        /// <summary>
        /// Loop for EQUIPMENT DETAILS
        /// </summary>
        [DataMember]
        [ListCount(10)]
        [Pos(24)]
        public virtual List<Loop_EQD_QUOTES> EQDLoop { get; set; }
        /// <summary>
        ...
        [ListCount(10)]
        [Pos(25)]
        public virtual List<Loop_RCS_QUOTES> RCSLoop { get; set; }
        /// <summary>
        ...
        [ListCount(10)]
        [Pos(26)]
        public virtual List<Loop_PAT_QUOTES> PATLoop { get; set; }
        /// <summary>
        /// Loop for PACKAGE
        /// </summary>
        [DataMember]
        [ListCount(10)]
        [Pos(27)]
        public virtual List<Loop_PAC_QUOTES_2> PACLoop { get; set; }
        /// <summary>
        ...
        [ListCount(99)]
        [Pos(28)]
        public virtual List<Loop_NAD_QUOTES_2> NADLoop { get; set; }
        /// <summary>
        /// Loop for ALLOWANCE OR CHARGE
        /// </summary>
        [DataMember]
        [ListCount(99)]
        [Pos(29)]
        public virtual List<Loop_ALC_QUOTES_2> ALCLoop { get; set; }
        /// <summary>
        ...
        [ListCount(10)]
        [Pos(30)]
        public virtual List<Loop_TDT_QUOTES> TDTLoop { get; set; }
        /// <summary>
        ...
        [ListCount(100)]
        [Pos(31)]
        public virtual List<Loop_SCC_QUOTES> SCCLoop { get; set; }
    }
    ...
    public class Loop_NAD_QUOTES
    {
        ...
        [ListCount(10)]
        [Pos(4)]
        public virtual List<Loop_RFF_QUOTES_2> RFFLoop { get; set; }
        /// <summary>
        /// Loop for DOCUMENT/MESSAGE DETAILS
        /// </summary>
        [DataMember]
        [ListCount(5)]
        [Pos(5)]
        public virtual List<Loop_DOC_QUOTES> DOCLoop { get; set; }
        /// <summary>
        /// Loop for CONTACT INFORMATION
        /// </summary>
        [DataMember]
        [ListCount(5)]
        [Pos(6)]
        public virtual List<Loop_CTA_QUOTES> CTALoop { get; set; }
    }
    ...
    public class Loop_NAD_QUOTES_2
    {
        ...
        [ListCount(5)]
        [Pos(4)]
        public virtual List<Loop_DOC_QUOTES_2> DOCLoop { get; set; }
        /// <summary>
        /// Loop for CONTACT INFORMATION
        /// </summary>
        [DataMember]
    ...
    public class Loop_PAC_QUOTES
    {
        ...
        [ListCount(10)]
        [Pos(3)]
        public virtual List<Loop_PCI_QUOTES> PCILoop { get; set; }
    }
    ...
    public class Loop_SCC_QUOTES
    {
        ...
        [ListCount(10)]
        [Pos(3)]
        public virtual List<Loop_QTY_QUOTES> QTYLoop { get; set; }
    }
    ...
    public class Loop_TDT_QUOTES
    {
        ...
        [ListCount(10)]
        [Pos(3)]
        public virtual List<Loop_LOC_QUOTES> LOCLoop { get; set; }
    }
    ...
    [Serializable()]
    [DataContract()]
    [Message("EDIFACT", "QUOTES")]
    public class TSQUOTES : EdiMessage
    {
        ...
        [ListCount(5)]
        [Pos(12)]
        public virtual List<Loop_CUX_QUOTES> CUXLoop { get; set; }
        /// <summary>
        /// Loop for PAYMENT TERMS BASIS
        /// </summary>
        [DataMember]
        ...
        [ListCount(25)]
        [Pos(17)]
        public virtual List<Loop_APR_QUOTES> APRLoop { get; set; }
        /// <summary>
        /// Loop for DELIVERY LIMITATIONS
        /// </summary>
        [DataMember]
        [Pos(18)]
        public virtual Loop_DLM_QUOTES DLMLoop { get; set; }
        /// <summary>
        /// Loop for NAME AND ADDRESS
        /// </summary>
        [DataMember]
        [ListCount(99)]
        [Pos(19)]
        public virtual List<Loop_NAD_QUOTES> NADLoop { get; set; }
        /// <summary>
        /// Loop for DETAILS OF TRANSPORT
        /// </summary>
        [DataMember]
        ...
        [ListCount(10)]
        [Pos(21)]
        public virtual List<Loop_PAC_QUOTES> PACLoop { get; set; }
        /// <summary>
        /// Loop for SCHEDULING CONDITIONS
        /// </summary>
        [DataMember]
        ...
        [ListCount(15)]
        [Pos(23)]
        public virtual List<Loop_ALC_QUOTES> ALCLoop { get; set; }
        /// <summary>
        /// Loop for LINE ITEM
        /// </summary>
        [DataMember]
        ...
        [ListCount(200000)]
        [Pos(24)]
        public virtual List<Loop_LIN_QUOTES> LINLoop { get; set; }
        /// <summary>
        /// SECTION CONTROL
        /// </summary>
        [DataMember]
        ...
        [ListCount(10)]
        [Pos(28)]
        public virtual List<Loop_ALC_QUOTES_3> ALCLoop2 { get; set; }
        /// <summary>
        /// Message Trailer
        /// </summary>
        [DataMember]
