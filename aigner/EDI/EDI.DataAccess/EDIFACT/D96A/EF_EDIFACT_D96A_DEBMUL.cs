namespace EdiFabric.Templates.EdifactD96A
{
    ...
    public class Loop_ALC_DEBMUL
    {
        ...
        [ListCount(5)]
        [Pos(6)]
        public virtual List<Loop_TAX_DEBMUL> TAXLoop { get; set; }
    }
    ...
    public class Loop_DLI_DEBMUL
    {
        ...
        [ListCount(5)]
        [Pos(5)]
        public virtual List<Loop_CUX_DEBMUL> CUXLoop { get; set; }
        /// <summary>
        /// Loop for ADJUSTMENT DETAILS
        /// </summary>
        [DataMember]
        [ListCount(10)]
        [Pos(6)]
        public virtual List<Loop_AJT_DEBMUL> AJTLoop { get; set; }
    }
    ...
    public class Loop_DOC_DEBMUL
    {
        ...
        [ListCount(9999)]
        [Pos(8)]
        public virtual List<Loop_DLI_DEBMUL> DLILoop { get; set; }
    }
    ...
    public class Loop_FCA_DEBMUL
    {
        ...
        [ListCount(6)]
        [Pos(3)]
        public virtual List<Loop_ALC_DEBMUL> ALCLoop { get; set; }
    }
    ...
    public class Loop_LIN_DEBMUL
    {
        ...
        [ListCount(3)]
        [Pos(5)]
        public virtual List<Loop_RFF_DEBMUL> RFFLoop { get; set; }
        /// <summary>
        /// Loop for FINANCIAL INSTITUTION INFORMATION
        /// </summary>
        [DataMember]
        [Required]
        [Pos(6)]
        public virtual Loop_FII_DEBMUL FIILoop { get; set; }
        /// <summary>
        /// Loop for FINANCIAL CHARGES ALLOCATION
        /// </summary>
        [DataMember]
        [ListCount(5)]
        [Pos(7)]
        public virtual List<Loop_FCA_DEBMUL> FCALoop { get; set; }
        /// <summary>
        ...
        [ListCount(9999)]
        [Pos(8)]
        public virtual List<Loop_SEQ_DEBMUL> SEQLoop { get; set; }
    }
    ...
    public class Loop_PRC_DEBMUL
    {
        ...
        [ListCount(9999)]
        [Pos(3)]
        public virtual List<Loop_DOC_DEBMUL> DOCLoop { get; set; }
        /// <summary>
        /// Loop for GENERAL INDICATOR
        /// </summary>
        [DataMember]
        [Pos(4)]
        public virtual Loop_GIS_DEBMUL_2 GISLoop { get; set; }
    }
    ...
    public class Loop_SEQ_DEBMUL
    {
        ...
        [DataMember]
        [Pos(6)]
        public virtual Loop_PAI_DEBMUL PAILoop { get; set; }
        /// <summary>
        /// Loop for MONETARY AMOUNT
        /// </summary>
        [DataMember]
        ...
        [ListCount(4)]
        [Pos(7)]
        public virtual List<Loop_MOA_DEBMUL> MOALoop { get; set; }
        /// <summary>
        /// Loop for NAME AND ADDRESS
        /// </summary>
        [DataMember]
        [ListCount(3)]
        [Pos(8)]
        public virtual List<Loop_NAD_DEBMUL> NADLoop { get; set; }
        /// <summary>
        /// Loop for PARTIES TO INSTRUCTION
        /// </summary>
        [DataMember]
        [ListCount(3)]
        [Pos(9)]
        public virtual List<Loop_INP_DEBMUL> INPLoop { get; set; }
        /// <summary>
        /// Loop for GENERAL INDICATOR
        /// </summary>
        [DataMember]
        [ListCount(10)]
        [Pos(10)]
        public virtual List<Loop_GIS_DEBMUL> GISLoop { get; set; }
        /// <summary>
        /// Loop for FINANCIAL CHARGES ALLOCATION
        /// </summary>
        [DataMember]
        ...
        [DataMember]
        [Pos(12)]
        public virtual Loop_PRC_DEBMUL PRCLoop { get; set; }
    }
    ...
    [Serializable()]
    [DataContract()]
    [Message("EDIFACT", "DEBMUL")]
    public class TSDEBMUL : EdiMessage
    {
        ...
        [ListCount(5)]
        [Pos(6)]
        public virtual List<Loop_FII_DEBMUL> FIILoop { get; set; }
        /// <summary>
        /// Loop for NAME AND ADDRESS
        /// </summary>
        [DataMember]
        ...
        [ListCount(9999)]
        [Pos(8)]
        public virtual List<Loop_LIN_DEBMUL> LINLoop { get; set; }
        /// <summary>
        /// CONTROL TOTAL
        /// </summary>
        [DataMember]
        ...
        [ListCount(5)]
        [Pos(10)]
        public virtual List<Loop_AUT_DEBMUL> AUTLoop { get; set; }
        /// <summary>
        /// Message Trailer
        /// </summary>
        [DataMember]
