namespace EdiFabric.Templates.EdifactD96A
{
    ...
    public class Loop_ALC_ORDRSP
    {
        ...
        [DataMember]
        [Pos(4)]
        public virtual Loop_QTY_ORDRSP_2 QTYLoop { get; set; }
        /// <summary>
        /// Loop for PERCENTAGE DETAILS
        /// </summary>
        [DataMember]
        [Pos(5)]
        public virtual Loop_PCD_ORDRSP PCDLoop { get; set; }
        /// <summary>
        ...
        [ListCount(2)]
        [Pos(6)]
        public virtual List<Loop_MOA_ORDRSP> MOALoop { get; set; }
        /// <summary>
        /// Loop for RATE DETAILS
        /// </summary>
        [DataMember]
        [Pos(7)]
        public virtual Loop_RTE_ORDRSP RTELoop { get; set; }
        /// <summary>
        ...
        [ListCount(5)]
        [Pos(8)]
        public virtual List<Loop_TAX_ORDRSP_2> TAXLoop { get; set; }
    }
    ...
    public class Loop_LIN_ORDRSP
    {
        ...
        [ListCount(999)]
        [Pos(16)]
        public virtual List<Loop_CCI_ORDRSP> CCILoop { get; set; }
        /// <summary>
        ...
        [ListCount(10)]
        [Pos(17)]
        public virtual List<Loop_PAT_ORDRSP> PATLoop { get; set; }
        /// <summary>
        /// Loop for ADJUSTMENT DETAILS
        /// </summary>
        [DataMember]
        [Pos(18)]
        public virtual Loop_AJT_ORDRSP AJTLoop { get; set; }
        /// <summary>
        ...
        [ListCount(25)]
        [Pos(19)]
        public virtual List<Loop_PRI_ORDRSP> PRILoop { get; set; }
        /// <summary>
        /// Loop for REFERENCE
        /// </summary>
        [DataMember]
        [ListCount(999)]
        [Pos(20)]
        public virtual List<Loop_RFF_ORDRSP> RFFLoop { get; set; }
        /// <summary>
        /// Loop for PACKAGE
        /// </summary>
        [DataMember]
        [ListCount(10)]
        [Pos(21)]
        public virtual List<Loop_PAC_ORDRSP_2> PACLoop { get; set; }
        /// <summary>
        ...
        [ListCount(9999)]
        [Pos(22)]
        public virtual List<Loop_LOC_ORDRSP_2> LOCLoop { get; set; }
        /// <summary>
        /// Loop for DUTY/TAX/FEE DETAILS
        /// </summary>
        [DataMember]
        [ListCount(10)]
        [Pos(23)]
        public virtual List<Loop_TAX_ORDRSP> TAXLoop { get; set; }
        /// <summary>
        ...
        [ListCount(99)]
        [Pos(24)]
        public virtual List<Loop_NAD_ORDRSP_2> NADLoop { get; set; }
        /// <summary>
        /// Loop for ALLOWANCE OR CHARGE
        /// </summary>
        [DataMember]
        [ListCount(99)]
        [Pos(25)]
        public virtual List<Loop_ALC_ORDRSP> ALCLoop { get; set; }
        /// <summary>
        ...
        [ListCount(10)]
        [Pos(26)]
        public virtual List<Loop_TDT_ORDRSP> TDTLoop { get; set; }
        /// <summary>
        ...
        [ListCount(5)]
        [Pos(27)]
        public virtual List<Loop_TOD_ORDRSP> TODLoop { get; set; }
        /// <summary>
        /// Loop for EQUIPMENT DETAILS
        /// </summary>
        [DataMember]
        [ListCount(10)]
        [Pos(28)]
        public virtual List<Loop_EQD_ORDRSP> EQDLoop { get; set; }
        /// <summary>
        ...
        [ListCount(100)]
        [Pos(29)]
        public virtual List<Loop_SCC_ORDRSP> SCCLoop { get; set; }
        /// <summary>
        ...
        [ListCount(100)]
        [Pos(30)]
        public virtual List<Loop_RCS_ORDRSP> RCSLoop { get; set; }
        /// <summary>
        /// Loop for STAGES
        /// </summary>
        [DataMember]
        [ListCount(10)]
        [Pos(31)]
        public virtual List<Loop_STG_ORDRSP> STGLoop { get; set; }
    }
    ...
    public class Loop_NAD_ORDRSP
    {
        ...
        [ListCount(5)]
        [Pos(5)]
        public virtual List<Loop_DOC_ORDRSP> DOCLoop { get; set; }
        /// <summary>
        /// Loop for CONTACT INFORMATION
        /// </summary>
        [DataMember]
        [ListCount(5)]
        [Pos(6)]
        public virtual List<Loop_CTA_ORDRSP> CTALoop { get; set; }
    }
    ...
    public class Loop_PAC_ORDRSP
    {
        ...
        [ListCount(5)]
        [Pos(3)]
        public virtual List<Loop_PCI_ORDRSP> PCILoop { get; set; }
    }
    ...
    public class Loop_PAC_ORDRSP_2
    {
        ...
        [DataMember]
        [Pos(5)]
        public virtual Loop_RFF_ORDRSP RFFLoop { get; set; }
        /// <summary>
        /// Loop for PACKAGE IDENTIFICATION
        /// </summary>
        [DataMember]
    ...
    public class Loop_SCC_ORDRSP
    {
        ...
        [ListCount(10)]
        [Pos(4)]
        public virtual List<Loop_QTY_ORDRSP> QTYLoop { get; set; }
    }
    ...
    public class Loop_STG_ORDRSP
    {
        ...
        [ListCount(3)]
        [Pos(2)]
        public virtual List<Loop_QTY_ORDRSP_3> QTYLoop { get; set; }
    }
    ...
    public class Loop_TDT_ORDRSP
    {
        ...
        [ListCount(10)]
        [Pos(2)]
        public virtual List<Loop_LOC_ORDRSP> LOCLoop { get; set; }
    }
    ...
    [Serializable()]
    [DataContract()]
    [Message("EDIFACT", "ORDRSP")]
    public class TSORDRSP : EdiMessage
    {
        ...
        [ListCount(99)]
        [Pos(10)]
        public virtual List<Loop_NAD_ORDRSP> NADLoop { get; set; }
        /// <summary>
        /// Loop for DUTY/TAX/FEE DETAILS
        /// </summary>
        [DataMember]
        ...
        [ListCount(5)]
        [Pos(12)]
        public virtual List<Loop_CUX_ORDRSP> CUXLoop { get; set; }
        /// <summary>
        /// Loop for PAYMENT TERMS BASIS
        /// </summary>
        [DataMember]
        ...
        [ListCount(10)]
        [Pos(16)]
        public virtual List<Loop_PAC_ORDRSP> PACLoop { get; set; }
        /// <summary>
        /// Loop for EQUIPMENT DETAILS
        /// </summary>
        [DataMember]
        ...
        [ListCount(25)]
        [Pos(19)]
        public virtual List<Loop_APR_ORDRSP> APRLoop { get; set; }
        /// <summary>
        /// Loop for ALLOWANCE OR CHARGE
        /// </summary>
        [DataMember]
        ...
        [ListCount(200000)]
        [Pos(22)]
        public virtual List<Loop_LIN_ORDRSP> LINLoop { get; set; }
        /// <summary>
        /// SECTION CONTROL
        /// </summary>
        [DataMember]
        ...
        [ListCount(10)]
        [Pos(26)]
        public virtual List<Loop_ALC_ORDRSP_2> ALCLoop2 { get; set; }
        /// <summary>
        /// Message Trailer
        /// </summary>
        [DataMember]
