...
{
    public partial class AddCodeProductIdFunctionQualifier : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "CodeProductIdFunctionQualifier",
                schema: "dbo",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CodeProductIdFunctionQualifier", x => x.Id);
                });
        }
