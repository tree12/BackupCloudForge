...
{
    public class CodeDescriptionFormatCode : BaseCodeEntity<CodeDescriptionFormatCode>
    {

        public override string CodeDefinitionText { get; }

        public override string StringCodeDefinitionText => @"     A     Free-form long description
