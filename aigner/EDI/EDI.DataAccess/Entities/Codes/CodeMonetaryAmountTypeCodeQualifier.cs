...
{
    public class CodeMonetaryAmountTypeCodeQualifier: BaseCodeEntity<CodeMonetaryAmountTypeCodeQualifier>
    {

        public override string CodeDefinitionText => @" 1     VAT, 1st value
