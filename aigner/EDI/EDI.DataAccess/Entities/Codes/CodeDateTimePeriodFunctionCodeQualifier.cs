...
{
    public class CodeDateTimePeriodFunctionCodeQualifier: BaseCodeEntity<CodeDateTimePeriodFunctionCodeQualifier>
    {

        public override string CodeDefinitionText => @" 1     Service completion date/time, actual
