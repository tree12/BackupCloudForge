...
{
    public class CodePartyQualifier : BaseCodeEntity<CodePartyQualifier>
    {
        public override string CodeDefinitionText { get; }
        public override string StringCodeDefinitionText => @"   AA     Party to be billed (AAR Accounting rule 11)
