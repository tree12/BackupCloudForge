...
{
    public class CodeTimeReferenceCode  :BaseCodeEntity<CodeTimeReferenceCode>
    {
        public override string CodeDefinitionText => @"1     Date of order
...
|    25    Date goods handed over for shipment by seller or agent
              Payment time reference is the date when goods are handed
              over for shipment by the seller or his agent.
     ...
     45    Date of bill of lading, consignment note or other transport
           document
              The date of issuance of a bill of lading, consignment
              note or similar transport document.
...
|    47    Date of negotiable instrument (draft, promissory note,
           bank)
              Payment time reference is the date of the negotiable
              instrument.

     48    Date of receipt of tool dependent initial samples plus
           unlimited absolute bank guarantee plus value added tax
              Payment time reference is date of receipt of tool
              dependent initial samples and unlimited absolute bank
              guarantee of a third party, who is liable to the full
              amount of the tooling (which is owned by the customer).
     ...
     55    Date of acceptance of tooling
              Payment time reference is date of acceptance of tooling
              or set of tooling.

     56    Date of receipt of tooling
              Payment time reference is date of receipt of tooling or
              set of tooling.

     57    Date of acceptance of first samples produced under
           production conditions
              Payment time reference is date of acceptance of first
              samples produced under production conditions.
...
|    63    Date of final acceptance of work
              Payment time reference is the date of final acceptance
              of work.
...
|    65    Date of certificate of final acceptance
              Payment time reference is the date of the certificate of
              final acceptance.
...
|    69    Invoice transmission date
              Payment time reference is the date of invoice
              transmission.
...
|    71    Date of presentation of documents
              Payment time reference is the date when documents are
              presented.
     ...
     83    Requested date of delivery
        ...
        public override string StringCodeDefinitionText => @"ZZZ Other reference date agreed upon between the parties";
